...
public class LDAPAuthenticationServicesServiceLocator extends org.apache.axis.client.Service implements co.com.claro.sisges.ldap.service.LDAPAuthenticationServicesService {
    ...
    public co.com.claro.sisges.ldap.service.LDAPAuthenticationServices getLDAPAuthenticationServices() throws javax.xml.rpc.ServiceException {
    ...
    public co.com.claro.sisges.ldap.service.LDAPAuthenticationServices getLDAPAuthenticationServices(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            co.com.claro.sisges.ldap.service.LDAPAuthenticationServicesSoapBindingStub _stub = new co.com.claro.sisges.ldap.service.LDAPAuthenticationServicesSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (co.com.claro.sisges.ldap.service.LDAPAuthenticationServices.class.isAssignableFrom(serviceEndpointInterface)) {
                co.com.claro.sisges.ldap.service.LDAPAuthenticationServicesSoapBindingStub _stub = new co.com.claro.sisges.ldap.service.LDAPAuthenticationServicesSoapBindingStub(new java.net.URL(LDAPAuthenticationServices_address), this);
                _stub.setPortName(getLDAPAuthenticationServicesWSDDServiceName());
                return _stub;
            }
        }
