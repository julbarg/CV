...
function loadMapOrigin() {
   ...
   google.maps.event.addListener(map, 'rightclick', function(e) {
      ...
      document.getElementById("form_admin_edit_service:lat").value = markerManual.position.lat();
      document.getElementById("form_admin_edit_service:lng").value = markerManual.position.lng();
   });
   ...
   google.maps.event.addListener(searchBox, 'places_changed', function() {
      ...
      for (var i = 0, place; place = places[i]; i++) {
         ...
         document.getElementById("form_admin_edit_service:lat").value = marker.position.lat();
         document.getElementById("form_admin_edit_service:lng").value = marker.position.lng();
