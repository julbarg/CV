...
@Table(
   name = "client_file")
@NamedQuery(
   name = "ClientFileEntity.findAll", query = "SELECT c FROM ClientFileEntity c")
public class ClientFileEntity implements Serializable {
   ...
   @Column(
      name = "id_client_file")
   private BigInteger idClientFile;
   ...
   public BigInteger getIdClientFile() {
      return this.idClientFile;
   }

   public void setIdClientFile(BigInteger idClientFile) {
