...
public class LDAPAuthenticationServicesServiceLocator extends org.apache.axis.client.Service implements
   LDAP.LDAPAuthenticationServicesService {
   ...
   public LDAPAuthenticationServicesServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName)
   ...
   public LDAP.LDAPAuthenticationServices getLDAPAuthenticationServices(java.net.URL portAddress)
      throws javax.xml.rpc.ServiceException {
      try {
         LDAP.LDAPAuthenticationServicesSoapBindingStub _stub = new LDAP.LDAPAuthenticationServicesSoapBindingStub(
            portAddress, this);
   ...
   public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
      try {
         if (LDAP.LDAPAuthenticationServices.class.isAssignableFrom(serviceEndpointInterface)) {
            LDAP.LDAPAuthenticationServicesSoapBindingStub _stub = new LDAP.LDAPAuthenticationServicesSoapBindingStub(
               new java.net.URL(LDAPAuthenticationServices_address), this);
            _stub.setPortName(getLDAPAuthenticationServicesWSDDServiceName());
            return _stub;
         }
   ...
   public javax.xml.namespace.QName getServiceName() {
      return new javax.xml.namespace.QName("http://service.ldap.sisges.claro.com.co",
         "LDAPAuthenticationServicesService");
   }
   ...
   public java.util.Iterator getPorts() {
      if (ports == null) {
         ...
         ports.add(new javax.xml.namespace.QName("http://service.ldap.sisges.claro.com.co",
